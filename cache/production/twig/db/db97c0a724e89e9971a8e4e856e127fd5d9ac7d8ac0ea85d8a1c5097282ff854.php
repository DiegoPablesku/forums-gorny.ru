...
/* overall_footer.html */
class __TwigTemplate_41533656e729b5be2f363351b61e6f0af93aac1701c758e898db49f39e45c590 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 117
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('ovelissimo_yametrika', '__main__'));
        $this->env->loadTemplate('@ovelissimo_yametrika/event/overall_footer_body_after.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 118
        echo "
</body>
