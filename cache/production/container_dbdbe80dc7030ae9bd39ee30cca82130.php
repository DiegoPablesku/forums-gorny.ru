...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'ovelissimo.yametrika.listener' => 'getOvelissimo_Yametrika_ListenerService',
        ...
        $this->privates = [
            ...
            'ovelissimo.yametrika.listener' => true,
            'pagination' => true,
    ...
    /**
     * Gets the private 'ovelissimo.yametrika.listener' shared service.
     *
     * @return \ovelissimo\yametrika\event\listener
     */
    protected function getOvelissimo_Yametrika_ListenerService()
    {
        return $this->services['ovelissimo.yametrika.listener'] = new \ovelissimo\yametrika\event\listener(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    }
